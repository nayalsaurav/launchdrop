...
import { Rocket, Zap, Github, Loader2 } from "lucide-react";
        ...
        <div className="relative z-10 p-16 max-w-2xl">
          ...
          <div className="mt-16 flex items-center gap-4 text-sm font-medium text-muted-foreground">
            <div className="flex -space-x-3">
              ...
              <div className="w-10 h-10 rounded-full border-2 border-background bg-zinc-400 flex items-center justify-center text-xs text-black font-bold">
                +2k
              </div>
            </div>
          ...
          <div className="w-full max-w-sm space-y-8">
            ...
            <div className="mt-8 space-y-6">
              <Button
                ...
                className="w-full h-14 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl text-md flex gap-3 items-center justify-center"
              >
                {loading ? (
                  <>
              ...
              <p className="text-xs text-center text-muted-foreground max-w-xs mx-auto leading-relaxed">
                By continuing, you agree to LaunchDrop's{" "}
